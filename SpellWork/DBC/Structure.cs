    ...
    public struct SpellProcEventEntry
    {
        ...
        {  
            return new[]
            {
                ...
                SpellName, 
                SchoolMask.ToHex(),
                SpellFamilyName.ToHex(),
                SpellFamilyMask[0,0].ToHex(),
                SpellFamilyMask[0,1].ToHex(),
                SpellFamilyMask[0,2].ToHex(),
                SpellFamilyMask[1,0].ToHex(),
                SpellFamilyMask[1,1].ToHex(),
                SpellFamilyMask[1,2].ToHex(),
                SpellFamilyMask[2,0].ToHex(),
                SpellFamilyMask[2,1].ToHex(),
                SpellFamilyMask[2,2].ToHex(),
                ProcFlags.ToHex(),
                ProcEx.ToHex(),
                PpmRate.ToString(), 
